...
export default class TimeSelect extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <div className={classnames('nui-time-select-out', className)} ref='container'>
        <div className='nui-time-select flex'>
          <div
            className='nui-time-select-wrap'
          ...
          >
            {this.hourList.map(item => (
              <div
                key={`hour${item}`}
                className={classnames('nui-time-select-wrap-inner', {
                  active:
