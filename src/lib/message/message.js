  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          {show && (
            <div className={classnames('nui-message', themeClass, className)}>
              <div className='nui-message-header'>
                <i className={classnames(iconClass)} />
              </div>
              <div className='nui-message-body'>{message}</div>
              {closable && (
                <div className='nui-message-close' onClick={this.handleClose}>
                  关闭
                </div>
              )}
            </div>
