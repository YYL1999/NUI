...
export default class Calendar extends React.Component {
  ...
  render() {
    ...
    const sizeClass = size ? `nui-calendar-${size}` : ''
    const days = this.getDate()

    return (
      <div className={classnames('nui-calendar', sizeClass, className)}>
        {showHeader && (
          <div className='nui-calendar-header'>
            <div className='nui-calendar-header-caption'>
              {currentMoment.format(captionFormat)}
            </div>
            {showToolbar && (
              <div className='nui-calendar-header-toolbar'>
        ...
        <div className='nui-calendar-body'>
          <div className='nui-calendar-weekgroup'>
            {weekdays.map(weekday => (
              <div key={weekday} className='nui-calendar-weekgroup-item'>
                {weekday}
              </div>
            ))}
          </div>
          <div className='nui-calendar-daygroup'>
            {days.map((day, index) => (
              <div
                ...
                className={classnames('nui-calendar-daygroup-item', {
                  disabled: !day.inMonth,
                  active: day.isToday,
                })}
              >
                <div
                  className={classnames('nui-calendar-daygroup-item-header', {
                    'text-secondary':
                ...
                <div className='nui-calendar-daygroup-item-body'>
                  {cellRender &&
                    cellRender({
                      day: day.text,
                      year: day.date.format(FORMAT.YEAR),
